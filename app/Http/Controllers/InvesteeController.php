    ...
    public function investee_plan_list(Request $request)
    {
      ...
      return DataTables::of($plans)
                          ...
                          ->addColumn('action' , function($plan){
                            return '<a href="javascript:void(0)"><i class="fas fa-trash-alt delete-plan text-danger" data-investee-id="'.$plan->id.'"></i></a>
                                    <a href="javascript:void(0)"><i class="fas fa-edit edit-plan text-success" data-investee-id="'.$plan->id.'"></i></a>
                                    <a href="javascript:void(0)"><a class="investee-plan" href="'.url("analyst/investee-plan/$plan->id").'"> <i class="fas fa-eye view-investee-plan" data-investee-id="'.$plan->id.'"></i></a>';
                          })
