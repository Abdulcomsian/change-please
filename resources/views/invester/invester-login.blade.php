...
<html lang="en">
	...
	<body id="kt_body" class="bg-white">
        <header class="d-flex justify-content-end" style="margin-right: 50px; margin-top:30px;">
            <button type="button" class="btn btn-primary" id="signup-btn" data-toggle="modal" data-target="#signup-modal">
                  Sign Up
            </button>
      </header>
        <!-- Modal -->
    <div class="modal fade" id="signup-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="border:none; font-size: 35px; color:grey;">
			...
			<div class="d-flex flex-column flex-xl-row flex-column-fluid">
				...
				<div class="d-flex flex-column flex-lg-row-fluid">
					...
					<div class="d-flex flex-row-fluid flex-center p-10">
						...
						<div class="d-flex flex-column">
							...
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="text-dark fs-2x mb-3">Welcome, Invester!</h1>
							<!--end::Title-->
							<!--begin::Description-->
				...
				<div class="flex-row-fluid d-flex flex-center justfiy-content-xl-first p-10">
					...
					<div class="d-flex flex-center p-15 shadow rounded w-100 w-md-550px mx-auto ms-xl-20">
						<!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate"  method="POST" action="{{ route('login') }}" id="kt_free_trial_form">
                            @csrf
                            <!--begin::Heading-->
