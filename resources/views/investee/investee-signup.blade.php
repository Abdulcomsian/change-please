		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-xl-row flex-column-fluid">
				...
				<div class="d-flex flex-column flex-lg-row-fluid">
					...
					<div class="d-flex flex-row-fluid flex-center p-10">
						...
						<div class="d-flex flex-column">
							...
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="text-dark fs-2x mb-3">Welcome, Investee!</h1>
							<!--end::Title-->
							<!--begin::Description-->
				...
				<div class="flex-row-fluid d-flex flex-center justfiy-content-xl-first p-10">
					...
					<div class="d-flex flex-column flex-center p-15 shadow rounded w-100 w-md-550px mx-auto ms-xl-20">
                    <!--begin::Heading-->
					...
					<!--begin::Heading-->
                        ...
                        @endif
						<!--begin::Form-->
                        <form class="form w-100" novalidate="novalidate"  method="POST" action="{{ route('register') }}" id="kt_free_trial_form">
                            @csrf
							...
							<div class="fv-row mb-10">
								...
								<input class="form-control form-control-solid" type="text" placeholder="Enter Name" name="name" autocomplete="off"   required/>
								@error('name')
                            ...
                            <!--begin::Row-->
							<div class="fv-row mb-10">
								<label class="form-label fw-bolder text-dark fs-6">Confirmed Password</label>
								<input class="form-control form-control-solid" type="password" placeholder="Enter Password" name="password_confirmation" autocomplete="off" />
                            </div>
							<!--end::Row-->
