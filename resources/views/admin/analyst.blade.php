                        ...
                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                            ...
                            <form id="kt_modal_new_target_form" class="form" action="#">
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" name="firstname" placeholder="Enter First Name"/>
                                </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <input type="text" class="form-control form-control-solid" name="lastname" placeholder="Enter Last Name"/>
                                </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <input type="email" class="form-control form-control-solid" name="lastname" placeholder="Enter Email" required/>
                                </div>
                                ...
                                <div class="d-flex flex-column mb-8 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <input type="password" class="form-control form-control-solid" name="lastname" placeholder="Enter Password" required/>
                                </div>
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">mnoumanb@gmail.com</a>
                                </td>
                                <td>
